...
import com.fernandoschimidt.paymentsystem.dto.PixChargeRequest;
...
//    @Value("${CLIENT_ID}")
    private String clientId ="Client_Id_3627ec8cee42b3cf1fb2a18d291a0951ef00b461";

//    @Value("${CLIENT_SECRET}")
    private String clientSecret ="Client_Secret_4810c2a501be52980f0c4992288578f3db8caf45";
